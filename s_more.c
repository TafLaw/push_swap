...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/08/21 11:57:36 by tmuzeren          #+#    #+#             */
/*   Updated: 2019/08/21 11:58:44 by tmuzeren         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	result(t_list **top, t_list **b, int k, int *ch)
{
	int i;
	int j;
	int res;
